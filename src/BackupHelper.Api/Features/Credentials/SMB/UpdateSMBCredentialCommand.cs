...
public class UpdateSMBCredentialCommandHandler : IRequestHandler<UpdateSMBCredentialCommand>
{
    ...
    {
        var existingTitle = SMBCredentialHelper.GetSMBCredentialTitle(
            request.ExistingCredential.Server,
            request.ExistingCredential.ShareName
        );
        var newTitle = SMBCredentialHelper.GetSMBCredentialTitle(
            request.NewCredential.Server,
            request.NewCredential.ShareName
        );
